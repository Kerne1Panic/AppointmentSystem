...
public class MainMenuController implements Initializable {
    ...
    {
        Parent customerMenuParent = FXMLLoader.load(getClass().getResource("/View/CustomerMenuView.fxml"));
    ...
    {
        Parent scheduleMenuParent = FXMLLoader.load(getClass().getResource("/View/ScheduleMenuView.fxml"));
    ...
    {
        Parent exitParent = FXMLLoader.load(getClass().getResource("/View/LogInView.fxml"));
